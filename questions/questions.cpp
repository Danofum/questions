...
int dataCheck1or8(int a) { // Проверка на нормальный ответ
    setlocale(LC_ALL, "ru");
...
int question(int answer2) {
    switch (answer2)
    {
        int answer;
    case 1:
        cout << "Вопрос 1. Чипи-Чипи или Чапа-Чапа?" << endl;
    ...
    case 2:
        cout << "Вопрос 2. Вам интересно изучать новые языки?" << endl;
        cout << "1. Да \t 2. Нет" << endl;
        cin >> answer;
        answer = dataCheck1or2(answer);
        if (answer == 1)
        ...
        break;
    case 3:
        cout << "Вопрос 3. Вы считаете себя организованным человеком?" << endl;
        cout << "1. Да \t 2. Нет" << endl;
        cin >> answer;
        answer = dataCheck1or2(answer);
        if (answer == 1)
    ...
    case 4:
        cout << "Вопрос 4. Вам нравится смотреть фильмы ужасов?" << endl;
        cout << "1. Да \t 2. Нет" << endl;
        cin >> answer;
        answer = dataCheck1or2(answer);
        if (answer == 1)
        ...
        break;
    case 5:
        cout << "Вопрос 5. Вы любите готовить дома?" << endl;
        cout << "1. Да \t 2. Нет" << endl;
        cin >> answer;
        answer = dataCheck1or2(answer);
        if (answer == 1)
        ...
        break;
    case 6:
        cout << "Вопрос 6. Вас вдохновляют исторические события?" << endl;
        cout << "1. Да \t 2. Нет" << endl;
        cin >> answer;
        answer = dataCheck1or2(answer);
        if (answer == 1)
    ...
    case 7:
        ...
        break;
    case 8:
        cout << "Вопрос 8. Идёте до конца?" << endl;
        cout << "1. Да \t 2. Нет" << endl;
        cin >> answer;
        answer = dataCheck1or2(answer);
        if (answer == 1)
